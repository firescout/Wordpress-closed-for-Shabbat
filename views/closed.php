<?php
    $geo_name_id = (isset($args->geo_name_id) && $args->geo_name_id != 0) ? $args->geo_name_id :"1023441";
    $end_time = (isset($args->end_time) && !empty($args->end_time)) ? $args->end_time : "18:00";
?>
<html>
...
<body>
    <div class="px-4 my-5 text-center">
        ...
        <h1 class="display-5 fw-bold">CLOSED FOR SHABBAT</h1>
